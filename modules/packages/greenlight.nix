...
perSystem = { pkgs, lib, ... }: let
  inherit (pkgs) stdenv fetchurl fetchFromGitHub fetchYarnDeps yarnConfigHook yarnBuildHook yarnInstallHook nodejs nspr nss mesa libglvnd alsa-lib libpulseaudio flac libxslt yq atk at-spi2-atk at-spi2-core cairo cups gtk3 pango libjpeg_original libxkbcommon unzip electron_42 makeWrapper makeDesktopItem copyDesktopItems autoPatchelfHook nix-update-script;
in {
