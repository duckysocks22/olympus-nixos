{ inputs, self, ... }:
{
  flake.homeModules.niri = { inputs, pkgs, ... }: {
    imports = [
      inputs.self.homeModules.dms
      inputs.self.homeModules.cursors
      ...
      settings = {
        outputs = {
          "PNP(AOC) CU34G2XP 1Q1R9UA004091" = {
            mode = { width = 3440; height = 1440; refresh = 180.0; };
            position = { x = 0; y = -0; };
            scale = 1.1;
          ...
          DP-1 = {
            mode = { width = 3840; height = 2160; refresh = 119.892; };
            enable = false;
          };
        };
        prefer-no-csd = true;
        ...
        window-rules = [
          ...
          { matches = [ { app-id = "^org\\.gnome\\."; } ]; draw-border-with-background = false; geometry-corner-radius = { top-left = 12.0; top-right = 12.0; bottom-left = 12.0; bottom-right = 12.0; }; clip-to-geometry = true; }
          { matches = [ { app-id = "^gnome-control-center$"; } { app-id = "^pavucontrol$"; } { app-id = "^nm-connection-editor$"; } ]; default-column-width = { proportion = 0.5; }; open-floating = false; }
          { matches = [ { app-id = "^gnome-calculator$"; } { app-id = "^galculator$"; } { app-id = "^blueman-manager$"; } { app-id = "^org\\.gnome\\.Nautilus$"; } { app-id = "^xdg-desktop-portal$"; } ]; open-floating = true; }
          { matches = [ { app-id = "^org\\.wezfurlong\\.wezterm$"; } { app-id = "Alacritty"; } { app-id = "zen"; } { app-id = "com.mitchellh.ghostty"; } { app-id = "kitty"; } ]; draw-border-with-background = false; }
          { matches = [ { is-active = false; } ]; opacity = 0.9; }
          { matches = [ { app-id = "firefox$"; title = "^Picture-in-Picture$"; } { app-id = "zoom"; } ]; open-floating = true; }
          { matches = [ { app-id = "Minecraft"; } { app-id = "yarc-launcher"; } { title = "Satisfactory  "; } { app-id = "factorio"; } { app-id = "steam_app_4576510"; } { app-id = "gamescope"; } { app-id = "ffxiv_dx11.exe"; } ]; open-fullscreen = true; open-floating = true; }
          { matches = [ { app-id = "unityhub"; } { app-id = "com.bitwig.BitwigStudio"; } { app-id = "synthv-studio.exe"; } { app-id = "wlfreerdp"; } { title = "FreeRDP"; } { app-id = "jellyfin-desktop"; } ]; open-maximized = true; }
          { matches = [ { app-id = "firefox"; } { app-id = "jellyfin-desktop"; } ]; opacity = 1.0; }
          { geometry-corner-radius = { top-left = 12.0; top-right = 12.0; bottom-left = 12.0; bottom-right = 12.0; }; clip-to-geometry = true; }
        ];
        layer-rules = [
