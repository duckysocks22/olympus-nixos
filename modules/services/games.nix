{ inputs, self, ... }: {
  flake.nixosModules.gameServers = { inputs, ... }: {
    imports = [ inputs.self.nixosModules.minecraftServer inputs.self.nixosModules.factorioServer ];
  };

  flake.nixosModules.minecraftServer = { pkgs, util, lib, ... }: {
  ...
  flake.nixosModules.factorioServer = { util, pkgs, lib, ... }: {
